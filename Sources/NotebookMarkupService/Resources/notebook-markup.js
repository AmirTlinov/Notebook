"use strict";
(() => {
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/marked/lib/marked.esm.js
  function A() {
...
Please report this to https://github.com/markedjs/marked.`, e) {
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/common/unicode.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/common/error-codes.js
  var ERR;
  (function(ERR2) {
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/tokenizer/preprocessor.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/common/token.js
  var TokenType;
  (function(TokenType2) {
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/entities/dist/esm/generated/decode-data-html.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/entities/dist/esm/decode-codepoint.js
  var _a;
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/entities/dist/esm/decode.js
  var CharCodes;
  (function(CharCodes2) {
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/common/html.js
  var NS;
  (function(NS2) {
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/tokenizer/index.js
  var State;
  (function(State2) {
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/parser/open-element-stack.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/parser/formatting-element-list.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/tree-adapters/default.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/common/doctype.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/common/foreign-content.js
  var MIME_TYPES = {
    TEXT_HTML: "text/html",
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/parser/index.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/entities/dist/esm/escape.js
  var getCodePoint = (
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/serializer/index.js
  ...
  // ../../../../Users/amir/Documents/projects/Notebook/MCP/node_modules/parse5/dist/index.js
  ...
  function documentExport(document) {
    ...
    function image(source, width, height) {
      ...
      if (!asset) {
        ...
        assets.push(asset);
        images.set(key, asset);
      }
      const dimensions = [
        width ? `width=${(width * 0.75).toFixed(4)}pt` : "",
        height ? `height=${(height * 0.75).toFixed(4)}pt` : "",
        !width && !height ? "scale=0.75" : "",
        "keepaspectratio"
      ].filter(Boolean);
    ...
    function renderNode(node) {
      ...
      if (tag === "svg") return target(node) + image(
        `data:image/svg+xml;base64,${base64UTF8(restoreMath(serializeOuter(node)))}`,
        length(attribute(node, "width")),
        length(attribute(node, "height"))
      );
...
`;
        ...
        case "strong":
        case "b":
          return `${prefix}\\textbf{${body2}}`;
        case "em":
        case "i":
          return `${prefix}\\emph{${body2}}`;
        case "code":
        case "kbd":
        case "samp":
          return `${prefix}\\texttt{${escapeTeX(restoreMath(plainText(node)))}}`;
        case "u":
          return `${prefix}\\underline{${body2}}`;
        case "sub":
          return `${prefix}\\textsubscript{${body2}}`;
        case "sup":
          return `${prefix}\\textsuperscript{${body2}}`;
        case "blockquote":
          return `
${prefix}\\begin{quote}${body2}\\end{quote}
`;
        case "ul":
        case "ol":
          return `
${prefix}\\begin{${tag === "ol" ? "enumerate" : "itemize"}}${body2}\\end{${tag === "ol" ? "enumerate" : "itemize"}}
`;
        case "li":
          return `
${prefix}\\item ${body2.trim()}
`;
        case "div":
        case "section":
        case "article":
...
\else\usebox{\NotebookExportImageBox}\fi\endgroup}`;
  ...
  function descendants(nodes) {
    const result = [], pending = nodes.map((node) => ({ node, depth: 1 })).reverse();
    while (pending.length) {
      const { node, depth } = pending.pop();
      result.push(node);
      if (depth > 256 || result.length > 2e5) throw new Error("resource_limit: Print content exceeds 256 nested levels or 200000 HTML nodes.");
  ...
  function length(value) {
    ...
    return number > 0 && number <= 16384 ? number : void 0;
  }
  function anchorName(value) {
    return "nb-" + Array.from(value).map((character) => character.codePointAt(0).toString(16)).join("-");
  }
  ...
  function notebookMarkup(request) {
    ...
    for (const index of markdownOperations) {
      ...
      values.html = f.parse(values.source, { async: false, gfm: true });
    }
