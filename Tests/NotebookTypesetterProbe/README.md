...
TeX bundle берётся из `Applications/prepare_notebook_tex.py`; его контрольная
...
Пока эти границы открыты, существующий экранный путь и изолированный Mac TeX
export сохраняются. Первичный полный bundle занимает около 1.4 ГиБ на диске;
