...
В текущих исходниках протокол 30 и manifest 9 передают канонические размещения
...
Bonjour объявляет версию обмена в имени `notebook-v30-<UUID>-<поколение>`; прежний writer
