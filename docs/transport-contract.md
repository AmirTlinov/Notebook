...
Протокол 11 и manifest 4 передают канонические размещения доски 3.
Версия 11 добавляет ограниченные запросы диктовки в прежний конверт чата;
аудио не входит в репликацию содержания. Несовпадающая версия пары
отказывается от обмена до декодирования неизвестных сообщений.
Bonjour объявляет версию обмена в имени `notebook-v10-<UUID>-<поколение>`; прежний writer
