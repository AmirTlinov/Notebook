...
## Пакетные программы: протокол 26 / manifest 9 (GUI-242, в разработке)
...
В текущих исходниках протокол 23 и manifest 8 передают канонические размещения
доски 3. Версия 23 заменяет ручное сопряжение account-authorized proof/ready;
версия 22 добавила сессионное выделение. Manifest содержания не изменён.
...
Bonjour объявляет версию обмена в имени `notebook-v23-<UUID>-<поколение>`; прежний writer
