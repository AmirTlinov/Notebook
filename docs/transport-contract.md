...
## Общая интеграция: протокол 35 / manifest 17
...
В текущих исходниках протокол 35 и manifest 17 объединяют полный TeX,
...
manifest 4–16 остаются читаемыми без переписывания истории.
...
Bonjour объявляет версию обмена в имени `notebook-v35-<UUID>-<поколение>`; прежний writer
