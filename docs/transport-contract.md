...
Протокол 13 и manifest 4 передают канонические размещения доски 3.
Версия 13 требует сохранения неизменных конкурентных авторов общего поля:
...
Bonjour объявляет версию обмена в имени `notebook-v13-<UUID>-<поколение>`; прежний writer
