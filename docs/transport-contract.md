...
В текущих development-исходниках протокол 27 и manifest 10 добавляют пакетные
программы к выпущенным в 26/9 каноническим размещениям доски 3 и цельному стиранию
...
manifest 4–9 остаются читаемыми без переписывания истории.
...
Bonjour объявляет версию обмена в имени `notebook-v27-<UUID>-<поколение>`; прежний writer
