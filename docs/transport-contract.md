...
Протокол 16 и manifest 4 передают канонические размещения доски 3.
Версия 16 добавляет подписанное поколение журнала для единой доставки через
...
Bonjour объявляет версию обмена в имени `notebook-v16-<UUID>-<поколение>`; прежний writer
