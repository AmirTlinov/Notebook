...
## Частичное стирание элементов

Ластик не удаляет фигуру целиком и не переводит её в растр. `elementTargets`
...
ластиком. Синхронизация требует обеих новых версий приложения — protocol 18,
новые manifest 5. Структура SQLite и существующие идентичности не меняются.
