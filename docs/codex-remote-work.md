...
32 секунд. Статус `рядом` требует интерфейс awdl0, не одного includePeerToPeer.
...
ветирует его из-за ещё не умершего старого TCP. Переключение retiring старого
поколения не отключает новое; все команды сохраняют исходный durable ID.
