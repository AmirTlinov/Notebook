...
document pinch и прямоугольники бумаги/обложки в обеих ориентациях. Новый Release
замер ещё не завершён; сам по себе этот PASS не доказывает устранения паузы.
