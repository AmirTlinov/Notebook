...
Итоговая установка пары и удаление старого приложения **не выполнены**. Полный проход ниже
...
[reliability-transition.md](reliability-transition.md). Обнаруженные новые записи
уже работающего Mac сохранены отдельно: [граница данных](current-mac-preservation.md).
