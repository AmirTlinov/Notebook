...
## Исправление открытия бумаги: кандидат 0.3.21 (24)
...
Финальный выбранный маршрут `.build/focused-paper-selected` прошёл:
8 Mac, 12 нативных iPad, 21 проверка выбора и 40 сборщика, без ошибок,
пропусков и runtime warnings. SHA-256 исходников:
`2ec855fc384467a3ad3b2f90c0947e4ac695831f426d2087f9d36519c6a784f4`.
Полный маршрут и UI повторно не запускались. Подписанная пара готовится;
физическое открытие после этой правки пока не подтверждено.
