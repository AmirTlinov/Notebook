...
возврат **116,987 мс**. Первые две цели **не достигнуты**. У первой медиана
demand→ready **159,554 мс**, ready→installed **1179,854 мс**: задержка находится
после подготовки, её нельзя скрыть числом content-ready. Это не touch-to-photon;
системное профилирование частей проходов включено в измерение.
