...
Амиру предложен решающий физический опыт: нажать микрофон, произнести
«В Notebook работает диктовка Codex», завершить запись и проверить черновик.
Его результат пока не получен. Микрофон физического iPad, реальная точность
распознавания и этот полный пользовательский цикл ещё не объявляются принятыми.
...
ошибки загрузки. Сравнение чёткости на физическом iPad в прежнем масштабе ещё
не завершено: сейчас открыт далёкий обзор; Амиру предложено приблизить таблицу.
Этот снимок не заменяет проверку читаемости, живого Pencil или полной приёмки.
