...
## 16 сентября, 19:36 UTC — отказ checkpoint не блокирует весь пул
...
Release-пара собирается отдельно от GUI-205. Установленная пара пока остаётся
`3f62b7b1…`: на iPad появился новый Pencil-ввод (revision 21), поэтому повторный
