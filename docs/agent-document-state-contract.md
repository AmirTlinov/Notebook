...
поздней человеческой доработки. Входящее слияние журнала состояния пока также
не адресовано. Здесь устранено полное чтение только у команды состояния и
её причинной отмены; общий выпуск не объявляется завершённым.
