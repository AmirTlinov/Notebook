...
без копии истории. Даты, модель и микрофон не имитируются: текущий контракт Codex
не отдаёт эти данные или действие панели. UUID задачи остаётся адресом доставки,
