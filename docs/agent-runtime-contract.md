...
`NotebookChatPanel` показывает белую панель до 560 × 640 points с радиусом 28,
...
и поля ввода. Правая область ограничена показанными рамками инструментов и
подключения, поэтому чат не закрывает навигацию страниц и Pencil.
...
Правка сохраняется как прежний `chat_job`, затем единственный metadata-клиент
