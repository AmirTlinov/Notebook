...
Двойное касание печатного блока открывает ближайшую строку его исходника по
SyncTeX **того самого установленного PDF**. Свежая модель не подменяет адрес
...
Экспорт берёт готовый PDF выбранной версии из того же store. Только области
живых программ дополняются снимками их существующих владельцев. Текст и векторы
не превращаются в изображение, а ссылки сохраняют цели. Выход Quartz пишет в
ограниченный sink. Экспорт не запускает независимую повторную HTML/TeX-вёрстку.
