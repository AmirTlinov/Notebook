...
Необходимый вопрос агента не исчезает по таймеру. Во время звонка видны состояние
и закреплённая задача без дублирования каждой голосовой реплики.
...
поэтому реальная амплитуда обновляет волну. Во время ожидания имени тот же
микрофон показывает амплитуду вокруг значка без второго захвата.
...
Когда просьба закончилась, 1,4 секунды тишины завершают запись. Пауза, уже
...
Подсвеченный микрофон с реальной амплитудой обозначает ожидание, волна — приём
речи, строка обработки — передачу и распознавание. Нажатие на микрофон ожидания
выключает и захват, и ожидание. Смена задачи,
