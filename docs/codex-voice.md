...
Одна кнопка голоса в раскрытом чате и компаньоне открывает одно меню:
начать живой разговор сейчас либо явно включить ожидание «GPT» для него.
...
а не зависает на системном запросе. Проверяются отсутствие peer при ожидании, остановка трека при mute,
...
кнопок открывает одно меню из чата и компаньона и сохраняет черновик, камеру
