...
У свёрнутого чата есть отдельные 44-точечные кнопки диктовки и голосового режима.
Переход к полному окну использует системную анимацию с учётом Reduce Motion.
Перенос принадлежит заголовку и его свободной области, а не кнопкам сворачивания
и управления. Режим разговора и завершение остаются внутри того же окна.
