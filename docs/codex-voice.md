...
## Диктовка в черновик через текущий вход Codex
...
повторное нажатие завершает запись. Состояние, время, уровень и отмена видны
в полном чате и компаньоне. Уход в фон и аудиопрерывание завершают захват.
...
Диктовка не создаёт поручение, не меняет разрешения задачи и не отправляет сообщение.
