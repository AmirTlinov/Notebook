...
const cards=scienceExamples.map(e=>`<article><a class="preview" href="${e.id}.html" aria-label="Открыть: ${e.title}"><iframe src="${e.id}.html" title="Миниатюра ${e.title}" tabindex="-1" aria-hidden="true" loading="lazy"></iframe></a><div class="caption"><h2><a href="${e.id}.html">${e.title}</a></h2></div></article>`).join('\n');
...
<main><header><h1>Семь способов увидеть связь.</h1></header><div class="gallery">${cards}</div></main></html>`);
